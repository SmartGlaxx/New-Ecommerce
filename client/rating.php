...
<?php
  ...
  ?>
  <div style='position: absolute;top:0; left:0;color:orange; font-size:10px'><span style='margin-left:80px;position:relative;color:darkgrey'>(No ratings available)</span></div><br>
<?php
}
?>
</div>
