...
<div class= "container" style ="z-index:20" <?php if(isset($_SESSION["first_name"])) {echo "style = 'margin-top:-5%;margin-left:-22%'";} ?> style = "Margin-top:0%"> 
	<ul class = "nav nav-tabs"style ="z-index:20">
		<li class = "" ><a href = "header_admin.php" class = "" data-toggle = "" style = "color:blue;font-size:15px; margin-left:20px;color:black;font-weight:bolder">HOME</a>
		</li>
		<li id='admin' style = "font-weight:bolder;color:black"><span style='color:blue;font-size:15px; margin-left:20px'>UPLOAD</span></li>
		<li id='orders' style = "font-weight:bolder;color:black"><span style='color:blue;font-size:15px; margin-left:20px'>ORDERS</span></li>
	</ul>
</div>
<div id='adm'>
	<h6 style='color:blue; text-align:center; margin-top:10vh'>Welcome to the Admin Panel</h6>
	<p style='color:blue;text-align:center ;margin-top:10vh'>Navigate to either Management Pages</p>
</div>
